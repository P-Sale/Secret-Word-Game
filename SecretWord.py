...
def main():
    ...
    while play:
        ...
        wordbank = ["python", "linux", "programming", "software", "engineer", "computer",
                    "java", "javascript", "aws", "html", "css", "learning", "amazon", "tlg"]
        guesses = []
        turn = 12
        ...
        while turn > 0:
            ...
            while True:
                ...
                if guess == int:
                    ...
                    print(
                        f"You already guessed {guess}, pick a different letter.")
